...
const CONSTRAINT_STATE_STATUSES = {
  ...
  'exc-choice': {
    ...
    'exc-choice_2': 'satisfied',
    'exc-choice_3': 'satisfied',
    'exc-choice_4': 'violated'
  },
  'resp-existence': {
    'resp-existence_1': 'satisfied',
    'resp-existence_2': 'satisfied',
    'resp-existence_3': 'temporary_violated'
  },
  'coexistence': {
    'coexistence_1': 'satisfied',
...
export function buildConstraintDFA(constraint, multiProcessAlphabet) {
  ...
  case 'neg-chain-succession':
    return build([ 'neg-chain-succession_1', 'neg-chain-succession_2', 'neg-chain-succession_3', 'neg-chain-succession_4', 'neg-chain-succession_5' ], [ 'neg-chain-succession_1' ], [ 'neg-chain-succession_1', 'neg-chain-succession_2', 'neg-chain-succession_3' ], (activity, add) => {
      ...
      if (activity === source) add('neg-chain-succession_2', 'neg-chain-succession_5');
...
export function addGlobalColor(dfa) {
  ...
  const violationStatuses = new Set([ 'violated', 'temporary_violated' ]);
  ...
  statesToIterate.forEach(state => {
    ...
    const hasViolation = statuses.some(status => violationStatuses.has(status));
